...
class DacpacDeployer {
    ...
    deploy() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sqlPackageDownloadPath = yield tc.downloadTool('https://abelsharedblob.blob.core.windows.net/abelblog/sqlpackage.exe.zip');
            // unzip it
            const sqlPackageExtractedFolder = yield tc.extractZip(sqlPackageDownloadPath, this.workspacePath + "\\sqlpackageexe");
